...
Time Decay: Skills depreciate as AI evolves. 2023 knowledge counts less in 2025.

Evidence Multiplier: Claims without proof are discounted (0.6x). Verified impact gets full credit.

Governance Pillar: Safety and responsibility are measured, not assumed.

Production Bonus: Learning on live projects gets 1.5x vs. sandbox training.

Anti-Gaming / Confidence Rating: Junk output, credit theft, and unused deployments penalized. Score reported with Low/Medium/High confidence based on evidence.
